...
const Courses = () => {
  return (
    <div className="flex flex-col rounded-lg bg-[#F7F7F7] md:flex-row md:rounded-[40px] sticky top-0">
      ...
      <div className="relative mt-5 flex items-center gap-2 rounded-b-lg bg-[#F9AEB5] md:mt-0 md:w-1/2 md:rounded-none md:rounded-r-[40px] md:px-10 lg:h-[600px] 2xl:px-20">
