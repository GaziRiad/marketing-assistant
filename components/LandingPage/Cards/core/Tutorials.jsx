...
const Tutorials = () => {
  return (
    <div className="flex flex-col rounded-lg bg-[#F7F7F7] md:flex-row md:rounded-[40px] lg:h-full sticky top-0">
      ...
      <div className="mt-5 flex items-center rounded-b-lg bg-[#107FAA] md:mt-0 md:rounded-none md:rounded-r-[40px] md:px-10 h-[500px] md:h-[700px] lg:h-[600px] md:w-1/2 2xl:px-32">
        <Image
